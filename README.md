...
=======
We do not recommend using the free public API from Opentopodata, as it is too slow at delivering the height data to the application. You can either host your own instance, which allows you to use your own datasets to display the height data or use another compatible elevation service (for example [Google Elevation API](https://developers.google.com/maps/documentation/elevation/start)). In case the map loading takes a lot of time, consider lowering the MeshResolution in the config.
>>>>>>> 25352db (updated README.md)
...
=======
**TopoSharp**: A layer for requesting height data from TopoSharp's v2 API. This includes being able to request data from the [TopoBathy3D layer](https://www.arcgis.com/home/item.html?id=0c69ba5a5d254118841d43f03aa3e97d) from esri.
>>>>>>> 25352db (updated README.md)
